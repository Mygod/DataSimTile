...
record TelephonySnapshot(int status, String error, int currentSubId, int currentSlotIndex,
                         String currentName, int targetSubId, int targetSlotIndex,
    ...
    static TelephonySnapshot error(Throwable throwable) {
        ...
        return new TelephonySnapshot(STATUS_ERROR, message, -1, -1, null, -1, -1, null, 0);
    }
    ...
    void writeToParcel(Parcel parcel) {
        ...
        parcel.writeInt(currentSlotIndex);
        parcel.writeString(currentName);
        parcel.writeInt(targetSubId);
        parcel.writeInt(targetSlotIndex);
